...
##  <a name="customizing"></a> Customizing Existing My Namespace Members  
 ...
 [!code-vb[VbVbcnExtendingMy#1](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnExtendingMy/VB/Class1.vb#1)]  
...
##  <a name="addingtoobjects"></a> Adding Members to My Objects  
 ...
 [!code-vb[VbVbcnExtendingMy#2](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnExtendingMy/VB/Class2.vb#2)]  
...
###  <a name="addingtonamespace"></a> Adding Members to the My Namespace  
 ...
 [!code-vb[VbVbcnExtendingMy#3](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnExtendingMy/VB/Class1.vb#3)]  
 ...
 [!code-vb[VbVbcnExtendingMy#4](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnExtendingMy/VB/Class1.vb#4)]  
...
##  <a name="addingevents"></a> Adding Events to Custom My Objects  
 ...
 [!code-vb[VbVbcnExtendingMy#5](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnExtendingMy/VB/Class1.vb#5)]  
 ...
 [!code-vb[VbVbcnExtendingMy#6](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnExtendingMy/VB/Class1.vb#6)]  
...
-   **Factory methods.** Some types are necessarily difficult to instantiate. Providing factory methods as extensions to the `My` namespace enables you to more easily discover and consume types that fall into this category. An example of a factory method that works well is `My.Computer.FileSystem.OpenTextFileReader`. There are several stream types available in the .NET Framework. By specifying text files specifically, the `OpenTextFileReader` helps the user understand which stream to use.  
 ...
 These guidelines do not preclude general design principles for class libraries. Rather, they are recommendations that are optimized for developers who are using Visual Basic and the `My` namespace. For general design principles for creating class libraries, see [Framework Design Guidelines](../Topic/Framework%20Design%20Guidelines.md).  
