...
4.  Add the following code in an `Event` procedure:  
     ...
     [!code-csharp[VbPowerPacksLine#1](../../../snippets/csharp/VS_Snippets_VBCSharp/VbPowerPacksLine/CS/VbPowerpacksLine.cs#1)]
     [!code-vb[VbPowerPacksLine#1](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbPowerPacksLine/VB/VBPowerpacksLine.vb#1)]  
