...
4.  Add the following code in an `Event` procedure:  
     ...
     [!code-csharp[VbPowerpacksShape#1](../../../snippets/csharp/VS_Snippets_VBCSharp/VbPowerpacksShape/CS/VbPowerpacksShape.cs#1)]
     [!code-vb[VbPowerpacksShape#1](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbPowerpacksShape/VB/VbPowerpacksShape.vb#1)]  
