...
5.  Double-click the <xref:System.Windows.Forms.Button> control to open the Code Editor, and add the following code to the `SearchButton_Click` event handler.  
     ...
     [!code-csharp[VbPowerPacksDataRepeaterSearch#1](../../../snippets/csharp/VS_Snippets_VBCSharp/VbPowerPacksDataRepeaterSearch/CS/DataRepeaterSearch.cs#1)]
     [!code-vb[VbPowerPacksDataRepeaterSearch#1](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbPowerPacksDataRepeaterSearch/VB/DataRepeaterSearch.vb#1)]  
