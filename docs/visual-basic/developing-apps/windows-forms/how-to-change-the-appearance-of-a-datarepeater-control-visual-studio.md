...
2.  In the <xref:Microsoft.VisualBasic.PowerPacks.DataRepeater.DrawItem> event handler, add code to set the properties:  
     ...
     [!code-csharp[VbPowerPacksDataRepeaterAppearance#1](../../../snippets/csharp/VS_Snippets_VBCSharp/VbPowerPacksDataRepeaterAppearance/CS/VbPowerPacksDataRepeaterAppearance.cs#1)]
     [!code-vb[VbPowerPacksDataRepeaterAppearance#1](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbPowerPacksDataRepeaterAppearance/VB/VbPowerPacksDataRepeaterAppearance.vb#1)]  
...
## Example  
 ...
 [!code-csharp[VbPowerPacksDataRepeaterAlternateBackColor#1](../../../snippets/csharp/VS_Snippets_VBCSharp/VbPowerPacksDataRepeaterAlternateBackColor/CS/AlternateBackColor.cs#1)]
 [!code-vb[VbPowerPacksDataRepeaterAlternateBackColor#1](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbPowerPacksDataRepeaterAlternateBackColor/VB/AlternateBackColor.vb#1)]  
