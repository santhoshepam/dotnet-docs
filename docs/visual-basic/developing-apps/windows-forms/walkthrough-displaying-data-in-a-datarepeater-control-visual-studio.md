...
5.  In the <xref:Microsoft.VisualBasic.PowerPacks.DataRepeater.DrawItem> event handler, add the following code to alternate the `BackColor`:  
     ...
     [!code-csharp[VbPowerPacksDataRepeaterWalkthrough#1](../../../snippets/csharp/VS_Snippets_VBCSharp/VbPowerPacksDataRepeaterWalkthrough/CS/DataRepeaterWalkthrough.cs#1)]
     [!code-vb[VbPowerPacksDataRepeaterWalkthrough#1](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbPowerPacksDataRepeaterWalkthrough/VB/DataRepeaterWalkthrough.vb#1)]  
...
6.  In the <xref:Microsoft.VisualBasic.PowerPacks.DataRepeater.DrawItem> event handler, add the following code to change the `ForeColor` of a label depending on a condition:  
     ...
     [!code-csharp[VbPowerPacksDataRepeaterWalkthrough#2](../../../snippets/csharp/VS_Snippets_VBCSharp/VbPowerPacksDataRepeaterWalkthrough/CS/DataRepeaterWalkthrough.cs#2)]
     [!code-vb[VbPowerPacksDataRepeaterWalkthrough#2](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbPowerPacksDataRepeaterWalkthrough/VB/DataRepeaterWalkthrough.vb#2)]  
...
2.  Add the following code to the `Form_Load` event:  
     ...
     [!code-csharp[VbPowerPacksDataRepeaterWalkthrough#3](../../../snippets/csharp/VS_Snippets_VBCSharp/VbPowerPacksDataRepeaterWalkthrough/CS/DataRepeaterWalkthrough.cs#3)]
     [!code-vb[VbPowerPacksDataRepeaterWalkthrough#3](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbPowerPacksDataRepeaterWalkthrough/VB/DataRepeaterWalkthrough.vb#3)]  
...
4.  Add the following code to the `BindingNavigatorDeleteItem_EnabledChanged` event handler:  
     ...
     [!code-csharp[VbPowerPacksDataRepeaterWalkthrough#4](../../../snippets/csharp/VS_Snippets_VBCSharp/VbPowerPacksDataRepeaterWalkthrough/CS/DataRepeaterWalkthrough.cs#4)]
     [!code-vb[VbPowerPacksDataRepeaterWalkthrough#4](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbPowerPacksDataRepeaterWalkthrough/VB/DataRepeaterWalkthrough.vb#4)]  
...
5.  Double-click the <xref:System.Windows.Forms.Button> control to open the Code Editor, and add the following code to the `SearchButton_Click` event handler.  
     ...
     [!code-csharp[VbPowerPacksDataRepeaterWalkthrough#5](../../../snippets/csharp/VS_Snippets_VBCSharp/VbPowerPacksDataRepeaterWalkthrough/CS/DataRepeaterWalkthrough.cs#5)]
     [!code-vb[VbPowerPacksDataRepeaterWalkthrough#5](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbPowerPacksDataRepeaterWalkthrough/VB/DataRepeaterWalkthrough.vb#5)]  
