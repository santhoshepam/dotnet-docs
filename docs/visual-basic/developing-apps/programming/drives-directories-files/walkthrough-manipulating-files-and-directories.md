...
2.  Add the following code to the `Click` event handler.  
     ...
     [!code-vb[VbVbcnMyFileSystem#103](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnMyFileSystem/VB/class2.vb#103)]  
...
3.  Add the following `ListFiles` method.  
     ...
     [!code-vb[VbVbcnMyFileSystem#104](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnMyFileSystem/VB/class2.vb#104)]  
...
2.  Add the following code to the `Click` event handler.  
     ...
     [!code-vb[VbVbcnMyFileSystem#105](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnMyFileSystem/VB/class2.vb#105)]  
...
3.  Add the following `GetTextForOutput` method.  
     ...
     [!code-vb[VbVbcnMyFileSystem#107](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnMyFileSystem/VB/class2.vb#107)]  
...
1.  Add the following code to the end of the `examineButton_Click` event handler.  
     ...
     [!code-vb[VbVbcnMyFileSystem#106](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnMyFileSystem/VB/class2.vb#106)]  
...
2.  Add the following code to the event handler.  
     ...
     [!code-vb[VbVbcnMyFileSystem#102](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnMyFileSystem/VB/class2.vb#102)]  
...
1.  Add the following `SetEnabled` method.  
     ...
     [!code-vb[VbVbcnMyFileSystem#108](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnMyFileSystem/VB/class2.vb#108)]  
...
## Full example using My.Computer.FileSystem  
 ...
 [!code-vb[VbVbcnMyFileSystem#101](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnMyFileSystem/VB/class2.vb#101)]  
...
## Full example using System.IO  
 ...
 [!code-vb[VbVbcnMyFileSystem#111](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnMyFileSystem/VB/class3.vb#111)]  
