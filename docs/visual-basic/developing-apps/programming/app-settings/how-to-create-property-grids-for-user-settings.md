...
3.  Set the `My.Settings` object as the selected object for the property grid.  
     ...
     [!code-vb[VbVbalrMyResources#11](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrMyResources/VB/Form1.vb#11)]  
  
4.  Configure the property grid to show only the user settings.  
  
     [!code-vb[VbVbalrMyResources#12](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrMyResources/VB/Form1.vb#12)]  
