...
3.  Add the `My.Application.Log.WriteEntry` method to the `Startup` event handler.  
     ...
     [!code-vb[VbVbalrMyApplicationLog#1](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrMyApplicationLog/VB/MyEventsFake.vb#1)]  
...
3.  Add the `My.Application.Log.WriteEntry` method to the `Shutdown` event handler.  
     ...
     [!code-vb[VbVbalrMyApplicationLog#2](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrMyApplicationLog/VB/MyEventsFake.vb#2)]  
...
## Example  
 ...
 [!code-vb[VbVbalrMyApplicationLog#3](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrMyApplicationLog/VB/MyEventsFake.vb#3)]  
