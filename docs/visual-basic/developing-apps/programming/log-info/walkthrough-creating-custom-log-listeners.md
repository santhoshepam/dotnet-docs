...
-   In your application, create a class named `SimpleListener` that inherits from <xref:System.Diagnostics.TraceListener>.  
     ...
     [!code-vb[VbVbalrMyApplicationLog#16](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrMyApplicationLog/VB/Form1.vb#16)]  
...
-   The following code shows how to determine the strongly named type name for `SimpleListener`.  
     ...
     [!code-vb[VbVbalrMyApplicationLog#17](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrMyApplicationLog/VB/Form1.vb#17)]  
