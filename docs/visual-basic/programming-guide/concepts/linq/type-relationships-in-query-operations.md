...
Parts of a LINQ query  
 ...
 [!code-vb[VbLINQTypeRels#1](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbLINQTypeRels/VB/Class1.vb#1)]  
...
>  Local type inference works only when `Option Infer` is set to `On`. For more information, see [Option Infer Statement](../../../../visual-basic/language-reference/statements/option-infer-statement.md).  
 ...
 [!code-vb[VbLINQTypeRels#4](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbLINQTypeRels/VB/Class1.vb#4)]  
...
## Queries That Return Entire Elements of the Source Data  
 ...
 [!code-vb[VbLINQTypeRels#2](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbLINQTypeRels/VB/Class1.vb#2)]  
 ...
 [!code-vb[VbLINQTypeRels#3](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbLINQTypeRels/VB/Class1.vb#3)]  
