...
## Specifying the Data Source (From)  
 ...
 [!code-vb[VbLINQBasicOps#1](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbLINQBasicOps/VB/Class1.vb#1)]  
...
## Filtering Data (Where)  
 ...
 [!code-vb[VbLINQBasicOps#2](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbLINQBasicOps/VB/Class1.vb#2)]  
...
## Ordering Data (Order By)  
 ...
 [!code-vb[VbLINQBasicOps#3](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbLINQBasicOps/VB/Class1.vb#3)]  
...
## Selecting Data (Select)  
 ...
 [!code-vb[VbLINQBasicOps#4](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbLINQBasicOps/VB/Class1.vb#4)]  
 ...
 [!code-vb[VbLINQBasicOps#5](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbLINQBasicOps/VB/Class1.vb#5)]  
...
-   In the `Select` clause, specify the fields you want to include in the result. The compiler will define an anonymous type that has those fields as its properties. For more information, see [Anonymous Types](../../../../visual-basic/programming-guide/language-features/objects-and-classes/anonymous-types.md).  
     ...
     [!code-vb[VbLINQBasicOps#6](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbLINQBasicOps/VB/Class1.vb#6)]  
...
-   Define a named type that contains the particular fields that you want to include in the result, and create and initialize instances of the type in the `Select` clause. Use this option only if you have to use individual results outside the collection in which they are returned, or if you have to pass them as parameters in method calls. The type of `londonCusts5` in the following example is IEnumerable(Of NamePhone).  
     ...
     [!code-vb[VbLINQBasicOps#7](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbLINQBasicOps/VB/Class1.vb#7)]  
  
     [!code-vb[VbLINQBasicOps#8](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbLINQBasicOps/VB/Class1.vb#8)]  
...
## Joining Data (Join and Group Join)  
 ...
 [!code-vb[VbLINQBasicOps#9](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbLINQBasicOps/VB/Class1.vb#9)]  
...
>  You can run this code with the list of students created in [How to: Create a List of Items](../../../../visual-basic/programming-guide/concepts/linq/how-to-create-a-list-of-items.md).  
 ...
 [!code-vb[VbLINQBasicOps#10](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbLINQBasicOps/VB/Class1.vb#10)]  
...
## Grouping Data (Group By)  
 ...
 [!code-vb[VbLINQBasicOps#11](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbLINQBasicOps/VB/Class1.vb#11)]  
 ...
 [!code-vb[VbLINQBasicOps#12](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbLINQBasicOps/VB/Class1.vb#12)]  
