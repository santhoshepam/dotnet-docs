...
##  <a name="vbconinteroperabilitymarshalinganchor2"></a> Exporting Fixed-Length Strings to Unmanaged Code  
 In Visual Basic 6.0 and earlier versions, strings are exported to COM objects as sequences of bytes without a null termination character. For compatibility with other languages, [!INCLUDE[vbprvblong](../../../includes/vbprvblong-md.md)] includes a termination character when exporting strings. The best way to address this incompatibility is to export strings that lack the termination character as arrays of `Byte` or `Char`.  
...
##  <a name="vbconinteroperabilitymarshalinganchor6"></a> Creating Instances of a .NET Framework Class  
 ...
 [!code-vb[VbVbalrInterop#20](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrInterop/VB/Class1.vb#20)]  
 ...
 [!code-vb[VbVbalrInterop#21](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrInterop/VB/Class1.vb#21)]  
...
##  <a name="vbconinteroperabilitymarshalinganchor8"></a> Module level COM methods  
 Most COM objects are used by creating an instance of a COM class using the `New` keyword and then calling methods of the object. One exception to this rule involves COM objects that contain `AppObj` or `GlobalMultiUse` COM classes. Such classes resemble module level methods in [!INCLUDE[vbprvblong](../../../includes/vbprvblong-md.md)] classes. Visual Basic 6.0 and earlier versions implicitly create instances of such objects for you the first time that you call one of their methods. For example, in Visual Basic 6.0 you can add a reference to the Microsoft DAO 3.6 Object Library and call the `DBEngine` method without first creating an instance:  
...
```  
 ...
 [!INCLUDE[vbprvblong](../../../includes/vbprvblong-md.md)] requires that you always create instances of COM objects before you can use their methods. To use these methods in [!INCLUDE[vbprvblong](../../../includes/vbprvblong-md.md)], declare a variable of the desired class and use the new keyword to assign the object to the object variable. The `Shared` keyword can be used when you want to make sure that only one instance of the class is created.  
  
 [!code-vb[VbVbalrInterop#23](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrInterop/VB/Class1.vb#23)]  
...
##  <a name="vbconinteroperabilitymarshalinganchor9"></a> Unhandled Errors in Event Handlers  
 ...
 [!code-vb[VbVbalrInterop#24](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrInterop/VB/Class1.vb#24)]  
...
### Understanding COM interop errors  
 ...
 [!code-vb[VbVbalrInterop#25](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrInterop/VB/Class1.vb#25)]  
...
##  <a name="vbconinteroperabilitymarshalinganchor10"></a> ActiveX Control Issues  
 Most ActiveX controls that work with Visual Basic 6.0 work with [!INCLUDE[vbprvblong](../../../includes/vbprvblong-md.md)] without trouble. The main exceptions are container controls, or controls that visually contain other controls. Some examples of older controls that do not work correctly with [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] are as follows:  
...
##  <a name="vbconinteroperabilitymarshalinganchor11"></a> Passing ReadOnly Properties of Controls ByRef  
 ...
 [!code-vb[VbVbalrInterop#26](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrInterop/VB/Class1.vb#26)]  
 ...
 [!code-vb[VbVbalrInterop#27](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrInterop/VB/Class1.vb#27)]  
