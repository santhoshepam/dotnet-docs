...
## Declaration Syntax  
 ...
 You declare each operand the same way you declare parameters for [Sub Procedures](../../../../visual-basic/programming-guide/language-features/procedures/sub-procedures.md).  
...
### Illustration of Declaration and Call  
 ...
 [!code-vb[VbVbcnProcedures#23](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnProcedures/VB/Class1.vb#23)]  
  
 The following example shows a typical call to the `+` operator defined on `veryLong`.  
  
 [!code-vb[VbVbcnProcedures#24](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnProcedures/VB/Class1.vb#24)]  
