---
title: "Function Procedures (Visual Basic) | Microsoft Docs"
ms.custom: ""
ms.date: "2015-07-20"
...
```  
 ...
 You declare each parameter the same way you do for [Sub Procedures](../../../../visual-basic/programming-guide/language-features/procedures/sub-procedures.md).  
...
### Illustration of Declaration and Call  
 ...
 [!code-vb[VbVbcnProcedures#1](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnProcedures/VB/Class1.vb#1)]  
  
 The following example shows a typical call to `hypotenuse`.  
  
 [!code-vb[VbVbcnProcedures#6](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnProcedures/VB/Class1.vb#6)]  
