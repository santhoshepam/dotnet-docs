...
3.  Following the parameter list, type a single expression as the body of the function. The value that the expression evaluates to is the value returned by the function. You do not use an `As` clause to specify the return type.  
     ...
     [!code-vb[VbVbalrLambdas#1](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrLambdas/VB/Class1.vb#1)]  
  
     You call the lambda expression by passing in an integer argument.  
  
     [!code-vb[VbVbalrLambdas#2](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrLambdas/VB/Class1.vb#2)]  
  
4.  Alternatively, the same result is accomplished by the following example:  
  
     [!code-vb[VbVbalrLambdas#3](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrLambdas/VB/Class1.vb#3)]  
...
3.  Following the parameter list, type a single statement as the body of the subroutine.  
     ...
     [!code-vb[VbVbalrLambdas#17](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrLambdas/VB/Class1.vb#17)]  
  
     You call the lambda expression by passing in a string argument.  
  
     [!code-vb[VbVbalrLambdas#18](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrLambdas/VB/Class1.vb#18)]  
...
4.  Within the body of the function, add the following code to create an expression and return the value. You do not use an `As` clause to specify the return type.  
     ...
     [!code-vb[VbVbalrLambdas#19](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrLambdas/VB/Class1.vb#19)]  
  
     You call the lambda expression by passing in an integer argument.  
  
     [!code-vb[VbVbalrLambdas#20](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrLambdas/VB/Class1.vb#20)]  
...
4.  Within the body of the function, add the following code to execute when the subroutine is invoked.  
     ...
     [!code-vb[VbVbalrLambdas#21](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrLambdas/VB/Class1.vb#21)]  
  
     You call the lambda expression by passing in a string argument.  
  
     [!code-vb[VbVbalrLambdas#22](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrLambdas/VB/Class1.vb#22)]  
...
## Example  
 ...
 [!code-vb[VbVbalrLambdas#10](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrLambdas/VB/Class4.vb#10)]  
 ...
 [!code-vb[VbVbalrLambdas#11](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrLambdas/VB/Class5.vb#11)]  
