...
1.  Place the following code in `Form1`:  
     ...
     [!code-vb[VbVbcnWalkthroughDeclaringAndRaisingEvents#4](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnWalkthroughDeclaringAndRaisingEvents/VB/Form1.vb#4)]  
...
3.  Add the following code to the `mWidget_PercentDone` event handler:  
     ...
     [!code-vb[VbVbcnWalkthroughDeclaringAndRaisingEvents#5](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnWalkthroughDeclaringAndRaisingEvents/VB/Form1.vb#5)]  
...
4.  Add the following code for the `Button2_Click` event handler:  
     ...
     [!code-vb[VbVbcnWalkthroughDeclaringAndRaisingEvents#6](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnWalkthroughDeclaringAndRaisingEvents/VB/Form1.vb#6)]  
...
3.  Add the following code for the `Form1_Load` event procedure to create the `Widget`:  
     ...
     [!code-vb[VbVbcnWalkthroughDeclaringAndRaisingEvents#7](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnWalkthroughDeclaringAndRaisingEvents/VB/Form1.vb#7)]  
...
-   Add the following code to the `Button1_Click` event handler:  
     ...
     [!code-vb[VbVbcnWalkthroughDeclaringAndRaisingEvents#8](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnWalkthroughDeclaringAndRaisingEvents/VB/Form1.vb#8)]  
...
-   Add the following line of code to the `Button1_Click` procedure, immediately preceding the line that reads `mWidget.LongTask(12.2, 0.33)`:  
     ...
     [!code-vb[VbVbcnWalkthroughDeclaringAndRaisingEvents#9](../../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnWalkthroughDeclaringAndRaisingEvents/VB/Form1.vb#9)]  
