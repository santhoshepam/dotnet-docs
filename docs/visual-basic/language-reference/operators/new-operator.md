...
## Remarks  
 ...
 [!code-vb[VbVbalrKeywords#11](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrKeywords/VB/Class6.vb#11)]  
  
 Since arrays are classes, `New` can create a new array instance, as shown in the following examples.  
  
 [!code-vb[VbVbalrKeywords#12](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrKeywords/VB/Class6.vb#12)]  
