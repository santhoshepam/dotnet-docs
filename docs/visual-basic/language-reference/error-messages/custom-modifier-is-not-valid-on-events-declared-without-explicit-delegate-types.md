...
1.  Define a delegate with the same parameter list as the custom event.  
     ...
     [!code-vb[VbVbalrEventError#18](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrEventError/VB/VbVbalrEventError.vb#18)]  
...
2.  Replace the parameter list of the custom event with an `As` clause specifying the delegate type.  
     ...
     [!code-vb[VbVbalrEventError#19](../../../snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrEventError/VB/VbVbalrEventError.vb#19)]  
