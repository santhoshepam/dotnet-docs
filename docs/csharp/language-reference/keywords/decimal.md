...
```  
 ...
 [!code-csharp[csrefKeywordsTypes#6](../../../snippets/csharp/VS_Snippets_VBCSharp/csrefKeywordsTypes/CS/keywordsTypes.cs#6)]  
...
## Example  
 ...
 [!code-csharp[csrefKeywordsTypes#7](../../../snippets/csharp/VS_Snippets_VBCSharp/csrefKeywordsTypes/CS/keywordsTypes.cs#7)]  
