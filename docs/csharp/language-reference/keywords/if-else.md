...
An `if` statement identifies which statement to run based on the value of a `Boolean` expression. In the following example, the `Boolean` variable `result` is set to `true` and then checked in the `if` statement. The output is `The condition is true`.  
 ...
 [!code-csharp[csrefKeywordsSelection#1](../../../snippets/csharp/VS_Snippets_VBCSharp/csrefKeywordsSelection/CS/csrefKeywordsSelection.cs#1)]  
...
```  
 ...
 [!code-csharp[csrefKeywordsSelection#2](../../../snippets/csharp/VS_Snippets_VBCSharp/csrefKeywordsSelection/CS/csrefKeywordsSelection.cs#2)]  
 ...
 [!code-csharp[csrefKeywordsSelection#3](../../../snippets/csharp/VS_Snippets_VBCSharp/csrefKeywordsSelection/CS/csrefKeywordsSelection.cs#3)]  
...
## Example  
 ...
 [!code-csharp[csrefKeywordsSelection#4](../../../snippets/csharp/VS_Snippets_VBCSharp/csrefKeywordsSelection/CS/csrefKeywordsSelection.cs#4)]  
...
## Example  
 ...
 [!code-csharp[csrefKeywordsSelection#5](../../../snippets/csharp/VS_Snippets_VBCSharp/csrefKeywordsSelection/CS/csrefKeywordsSelection.cs#5)]  
...
## Example  
 ...
 [!code-csharp[csrefKeywordsSelection#6](../../../snippets/csharp/VS_Snippets_VBCSharp/csrefKeywordsSelection/CS/csrefKeywordsSelection.cs#6)]  
...
## See Also  
 ...
 [if-else Statement (C++)](/visual-cpp/cpp/if-else-statement-cpp)   
