...
-   A local *range variable* that represents each element in the source sequence.  
 ...
 [!code-csharp[cscsrefQueryKeywords#1](../../../snippets/csharp/VS_Snippets_VBCSharp/CsCsrefQueryKeywords/CS/From.cs#1)]  
...
## Compound from Clauses  
 ...
 [!code-csharp[cscsrefQueryKeywords#2](../../../snippets/csharp/VS_Snippets_VBCSharp/CsCsrefQueryKeywords/CS/From.cs#2)]  
...
## Using Multiple from Clauses to Perform Joins  
 ...
 [!code-csharp[cscsrefQueryKeywords#3](../../../snippets/csharp/VS_Snippets_VBCSharp/CsCsrefQueryKeywords/CS/From.cs#3)]  
