...
The `switch` statement is a control statement that selects a *switch section* to execute from a list of candidates.  
 ...
 [!code-csharp[csrefKeywordsSelection#7](../../../snippets/csharp/VS_Snippets_VBCSharp/csrefKeywordsSelection/CS/csrefKeywordsSelection.cs#7)]  
...
## Example  
 ...
 [!code-csharp[csrefKeywordsSelection#9](../../../snippets/csharp/VS_Snippets_VBCSharp/csrefKeywordsSelection/CS/csrefKeywordsSelection.cs#9)]  
  
## Example  
 In the final example, the string variable, `str`, and string case labels control the flow of execution.  
  
 [!code-csharp[csrefKeywordsSelection#8](../../../snippets/csharp/VS_Snippets_VBCSharp/csrefKeywordsSelection/CS/csrefKeywordsSelection.cs#8)]  
