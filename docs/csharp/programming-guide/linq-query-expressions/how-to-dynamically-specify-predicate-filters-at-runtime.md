...
4.  Replace class `Program` with the following code.  
     ...
     [!code-csharp[csProgGuideLINQ#26](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideLINQ/CS/csrefLINQHowTos.cs#26)]  
...
2.  Copy the following method and paste it into class `DynamicPredicates`.  
     ...
     [!code-csharp[csProgGuideLINQ#27](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideLINQ/CS/csrefLINQHowTos.cs#27)]  
