...
## Joining Multiple Inputs into One Output Sequence  
 ...
 [!code-csharp[CsLINQGettingStarted#7](../../../../snippets/csharp/VS_Snippets_VBCSharp/CsLINQGettingStarted/CS/Class1.cs#7)]  
  
 The following example shows the query:  
  
 [!code-csharp[CSLinqGettingStarted#8](../../../../snippets/csharp/VS_Snippets_VBCSharp/CsLINQGettingStarted/CS/Class1.cs#8)]  
...
## Transforming in-Memory Objects into XML  
 ...
 [!code-csharp[CsLINQGettingStarted#9](../../../../snippets/csharp/VS_Snippets_VBCSharp/CsLINQGettingStarted/CS/Class1.cs#9)]  
...
> [!NOTE]
>  Calling methods in query expressions is not supported if the query will be translated into some other domain. For example, you cannot call an ordinary C# method in [!INCLUDE[vbtecdlinq](../../../../includes/vbtecdlinq-md.md)] because SQL Server has no context for it. However, you can map stored procedures to methods and call those. For more information, see [Stored Procedures](../Topic/Stored%20Procedures.md).  
  
 [!code-csharp[CsLINQGettingStarted#10](../../../../snippets/csharp/VS_Snippets_VBCSharp/CsLINQGettingStarted/CS/Class1.cs#10)]  
