...
The actions that a program takes are expressed in statements. Common actions include declaring variables, assigning values, calling methods, looping through collections, and branching to one or another block of code, depending on a given condition. The order in which statements are executed in a program is called the flow of control or flow of execution. The flow of control may vary every time that a program is run, depending on how the program reacts to input that it receives at run time.  
 ...
 [!code-csharp[csProgGuideStatements#1](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideStatements/CS/Statements.cs#1)]  
...
|--------------|---------------------------|  
|Declaration statements|A declaration statement introduces a new variable or constant. A variable declaration can optionally assign a value to the variable. In a constant declaration, the assignment is required.<br /><br /> [!code-csharp[csProgGuideStatements#23](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideStatements/CS/Statements.cs#23)]|  
|Expression statements|Expression statements that calculate a value must store the value in a variable.<br /><br /> [!code-csharp[csProgGuideStatements#24](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideStatements/CS/Statements.cs#24)]|  
...
## Embedded Statements  
 ...
 [!code-csharp[csProgGuideStatements#26](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideStatements/CS/Statements.cs#26)]  
 ...
 [!code-csharp[csProgGuideStatements#27](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideStatements/CS/Statements.cs#27)]  
  
 Put the embedded statement in a block to fix the error:  
  
 [!code-csharp[csProgGuideStatements#28](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideStatements/CS/Statements.cs#28)]  
  
## Nested Statement Blocks  
 Statement blocks can be nested, as shown in the following code:  
  
 [!code-csharp[csProgGuideStatements#29](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideStatements/CS/Statements.cs#29)]  
...
## Unreachable Statements  
 ...
 [!code-csharp[csProgGuideStatements#22](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideStatements/CS/Statements.cs#22)]  
