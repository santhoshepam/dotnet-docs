...
-   To split a class definition, use the [partial](../../../csharp/language-reference/keywords/partial-type.md) keyword modifier, as shown here:  
 ...
 [!code-csharp[csProgGuideObjects#26](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideObjects/CS/Objects.cs#26)]  
...
>  The `partial` modifier is not available on delegate or enumeration declarations.  
 ...
 [!code-csharp[csProgGuideObjects#25](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideObjects/CS/Objects.cs#25)]  
  
 At compile time, attributes of partial-type definitions are merged. For example, consider the following declarations:  
  
 [!code-csharp[csProgGuideObjects#23](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideObjects/CS/Objects.cs#23)]  
  
 They are equivalent to the following declarations:  
  
 [!code-csharp[csProgGuideObjects#24](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideObjects/CS/Objects.cs#24)]  
...
-   members  
 ...
 [!code-csharp[csProgGuideObjects#21](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideObjects/CS/Objects.cs#21)]  
  
 They are equivalent to the following declarations:  
  
 [!code-csharp[csProgGuideObjects#22](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideObjects/CS/Objects.cs#22)]  
...
-   All partial-type definitions meant to be parts of the same type must be modified with `partial`. For example, the following class declarations generate an error:  
     ...
     [!code-csharp[csProgGuideObjects#20](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideObjects/CS/Objects.cs#20)]  
  
-   The `partial` modifier can only appear immediately before the keywords `class`, `struct`, or `interface`.  
  
-   Nested partial types are allowed in partial-type definitions as illustrated in the following example:  
  
     [!code-csharp[csProgGuideObjects#19](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideObjects/CS/Objects.cs#19)]  
...
### Code  
 [!code-csharp[csProgGuideObjects#17](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideObjects/CS/Objects.cs#17)]  
...
### Code  
 [!code-csharp[csProgGuideObjects#18](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideObjects/CS/Objects.cs#18)]  
