...
The ability to access a member in the global [namespace](../../../csharp/language-reference/keywords/namespace.md) is useful when the member might be hidden by another entity of the same name.  
 ...
 [!code-csharp[csProgGuideNamespaces#1](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideNamespaces/CS/Namespaces.cs#1)]  
  
 Using `System.Console` still results in an error because the `System` namespace is hidden by the class `TestApp.System`:  
  
 [!code-csharp[csProgGuideNamespaces#2](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideNamespaces/CS/Namespaces.cs#2)]  
  
 However, you can work around this error by using `global::System.Console`, like this:  
  
 [!code-csharp[csProgGuideNamespaces#3](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideNamespaces/CS/Namespaces.cs#3)]  
 ...
 [!code-csharp[csProgGuideNamespaces#4](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideNamespaces/CS/Namespaces.cs#4)]  
...
## Example  
 ...
 [!code-csharp[csProgGuideNamespaces#5](../../../snippets/csharp/VS_Snippets_VBCSharp/csProgGuideNamespaces/CS/Namespaces.cs#5)]  
